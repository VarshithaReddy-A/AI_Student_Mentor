...
// Flat unique list of all skills across all roles
const ALL_SKILLS = [
  ...new Set(Object.values(ROLE_SKILLS).flat()),
].sort();
    ...
    <div className="sg-page">
      ...
      >
        ...
        <div className="sg-field">
          ...
          <label>
            Skills needed for{" "}
            <span className="sg-hint-role">
              {selectedRole}
            </span>

            <span>
              {" "}
              — click to add any you have
            </span>
          </label>
        ...
        >
          ...
          <label htmlFor="sg-search">
            Search &amp; add skills{" "}
            <span>
              (or type a custom skill and press
              Enter)
            </span>
          </label>
        ...
        <div className="sg-results">
          ...
          <div className="sg-score-card">
            ...
            <div className="sg-score-left">
              ...
              <span className="sg-score-role">
                {result.role}
              </span>

              <span className="sg-score-lbl">
                Skill match score
              </span>

              <div
                className="sg-score-num"
                style={{
                  color: scoreColor,
                }}
              >
          ...
          {(result.known_skills || [])
            ...
            <div className="sg-panel">
              ...
              <div className="sg-pills">
                ...
                {result.known_skills.map(
                  (s, i) => (
                    <span
                      key={i}
                      className="sg-pill sg-pill-ok"
                    >
                      {s}
                    </span>
                  )
              ...
              <div className="sg-pills">
                ...
                {result.missing_skills.map(
                  (s, i) => (
                    <span
                      key={i}
                      className="sg-pill sg-pill-miss"
                    >
                      {s}
                    </span>
                  )
